...
import dev.patron.dsl.STRING_TEMPLATE_MARKER
            ...
            Calculator {
                ...
                constructors {
                    constructor {
                        ...
                        code {
                            -("this.$LITERAL_MARKER = $LITERAL_MARKER" to listOf("num1", "val1"))
                            -("this.$LITERAL_MARKER = $LITERAL_MARKER" to listOf("num2", "val2"))
                        }
                    }
                }
                functions {
